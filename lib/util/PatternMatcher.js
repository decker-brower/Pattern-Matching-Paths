...
PatternMatcher.buildPatternTree = function() {
    ...
    var bar = new ProgressBar('  Building the pattern tree [:bar] :percent elapsed: :elapsed estimated: :etas', {
        complete: '=',
        incomplete: ' ',
        width: 40,
...
PatternMatcher.findMatches = function() {
    ...
    var result = [];
    var bar = new ProgressBar('  Matching paths to patterns [:bar] :percent elapsed: :elapsed estimated: :etas', {
        complete: '=',
        incomplete: ' ',
        width: 40,
        total: this.pathCount
    });
